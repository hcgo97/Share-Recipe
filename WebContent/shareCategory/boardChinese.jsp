...
if( division != null ) { 
    sqlTot  += " and "+division+" like '%"+searchText+"%' ";
 }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            ...
                            <div class="category-img text-center">
                                <a href="boardKorean.jsp"> <img src="../logo/category_korean.png"></a>
                                <a href="boardWestern.jsp"> <img src="../logo/category_western.png"></a>
                                <a href="boardChinese.jsp"> <img src="../logo/category_chinese.png"></a>
                                <a href="boardOther.jsp"> <img src="../logo/category_other.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <h2>♥ 중식 : 최근레시피 ♥</h2>
                             ...
                             <table border="1" width="630px" align="center">
								...
								String sql2 = "select b.* from ( "
										 	+ "		select rownum rn, a.* from ( "
											+ "			select unq,title,userid,category,mat,recipe,hits, "
											+ " 			to_char(rdate,'yyyy-mm-dd') rdate, "
											+ "					(select count(*) from reply where board_unq = b.unq) as total "
											+ " 				from board_tbl b "
											+ "		where category = '중식' ";
							...
							if(division != null && chk != null ){
								sql2 += " and "+division+" " + " not like '%"+searchText+"%' " ;	
							}
							...
							<table border="0" width="600" align="center">
								<tr>
									...
									%>
										  <a href="boardChinese.jsp?page=<%=i %>" style = "color:black"><%=i %></a> 
									<%
									}
									%>
		                        ...
		                        <div class="col-xl-7 col-lg-9 col-md-8">
		                            <div class="wantToWork-caption wantToWork-caption2">
		                                <div class="main-menu2">
		                                    <nav>
		                                        <ul>
		                                            <li><a href="../shareMain/newmain.jsp">Home</a></li>
		                                            <li><a href="../shareCategory/boardKorean.jsp">Korean</a></li>
		                                            <li><a href="../shareCategory/boardWestern.jsp">Western</a></li> 
		                                            <li><a href="../shareCategory/boardChinese.jsp">Chinese</a></li>
		                                            <li><a href="../shareCategory/boardOther.jsp">Other</a></li>
