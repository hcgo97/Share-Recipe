...
<tr>
	...
	<tr>
		<td>  <input type="text" name="userid" placeholder="아이디를 입력해주세요" size="40" style="border: 1px solid #000000;"></td>
	</tr>
		
	<tr>	
		<td colspan="2"><input class="btn1" type="submit" value="아이디로 비밀번호 찾기"/></td>
	</tr>
