...
<form name="find" method="post" action="updatePro.jsp">	
	<div class="findid">
	<table>
		<tr>
			<p><font size="35" font color="black">사용자정보 수정</font></p>
		</tr>
		...
		<tr>
			...
			<td> <input type="password" name="pass" id = "pass" placeholder="비밀번호를 입력해주세요" size="40" style="border: 1px solid #000000;"></td>
	
		
		<tr>	
			<td colspan="2"><input class="btn1" type="submit" value="회원정보 수정" onclick = "fn_submit();return false;"></td>
		</tr>
		</table>
	</div>
</form>
