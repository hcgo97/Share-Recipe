...
<body>
	...
	<form name="passUpdate" method="post" action="passUpdate.jsp">
		<label>새 비밀번호 입력</label><input type="password" name="pass" style= "width:260px" > <br>
		<label>새 비밀번호 확인</label><input type="password" name="pass1" style= "width:260px"> <br>
		<input class="btn12" type="submit" value="비밀번호 변경" onclick = "fn_submit(); return false;"> <br>
	</form>
	<button class="btn3" onclick="location='deleteForm.jsp'">회원탈퇴</button>
</div> 	
