...
<form name="find" method="post" action="deletePro.jsp">
	<div class="findid">
		<table>
			<tr>
			<td><h1>사용자정보 삭제 페이지 입니다.</h1></td>
				</tr>
			
			<tr>
				<td><b>비밀번호 입력</b><input type="password" name="pass" id = "pass"></td>
			</tr>
				
			<tr>	
				 <td><input class="btn4" type="submit" value="회원탈퇴" onclick = "fn_submit();return false;"></td>
			</tr>
