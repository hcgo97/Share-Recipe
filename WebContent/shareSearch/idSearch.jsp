...
String idSearch = request.getParameter("userid");
%>
<%
int unit = 10;
                        ...
                        <div class="col-xl-10 col-lg-10">
                            ...
                            <form action="#" class="search-box mb-100">
                                ...
                                <div class="search-form">
                                	...
                                	<br>
                                	<i class="ti-search"></i><button class = "search" type = "submit" id="submit" onclick="fn_search()">Search</button>
...
<div class="popular-location border-bottom section-padding40">
    <div class="container">
        <div class="row">
			...
			<%
			String sql = "select b.* from (select rownum rn, a.* from (select unq,title,userid,category,mat,recipe,hits,to_char(rdate,'yyyy-mm-dd') rdate, (select count(*) from reply where board_unq = b.unq) as total from board_tbl b ";
			...
			sql +=  " where userid = '"+idSearch+"' "+"  and rn >= "+startIdx+" and rn <= "+endIdx ;
