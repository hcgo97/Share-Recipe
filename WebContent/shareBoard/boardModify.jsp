...
String sql = " select title,category,mat,recipe from board_tbl "
		   + "   where unq='"+unq+"'  ";
                    ...
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <!-- Header-btn -->
                        	...
                        	<table width = "50px">
                        		...
                        		<td style = "colorzsdad:white;" width = "70%"><%=SessionId %>님</td>
                        		</tr>
                        		<tr>
...
<table border="1" width="600" align="center">
	...
	<tr>
		...
		<td align="left">
		<textarea name="mat" rows="10" cols="50" placeholder = "※쉼표로 구분해주세요."><%=mat %></textarea>
		</td>
	</tr>
	...
	<tr>
		<td colspan = "2" >
			<textarea id = "summernote" name = "recipe"><%=recipe %></textarea>
		</td>
	</tr>
